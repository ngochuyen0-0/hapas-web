...
async function main() {
    ...
    data: [
      {
        ...
        description:
          'Những chiếc túi xách thanh lịch phù hợp cho môi trường công sở chuyên nghiệp. Thiết kế tinh tế, chất liệu cao cấp, nhiều ngăn tiện ích giúp bạn tổ chức đồ dùng một cách gọn gàng và chuyên nghiệp.',
        is_active: true,
      },
      {
        name: 'Túi Xách Thời Trang',
        description:
          'Túi xách thiết kế thời trang cho các dịp đi chơi, dạo phố. Với nhiều kiểu dáng và màu sắc đa dạng, các sản phẩm này sẽ giúp bạn nổi bật và thể hiện phong cách cá nhân.',
        is_active: true,
      },
      {
        name: 'Ba Lô',
        description:
          'Ba lô thời trang và tiện dụng cho công việc và du lịch. Với thiết kế ergonomic, đệm lưng thoáng khí và nhiều ngăn chứa, ba lô của chúng tôi là lựa chọn lý tưởng cho sinh viên, nhân viên văn phòng và những người yêu thích du lịch.',
        is_active: true,
      },
      {
        name: 'Ví',
        description:
          'Các loại ví da cao cấp cho nam và nữ. Từ ví cầm tay sang trọng đến ví dài cá tính, tất cả đều được làm từ chất liệu da thật hoặc da cao cấp, đảm bảo độ bền và tính thẩm mỹ cao.',
        is_active: true,
      },
      {
        name: 'Túi Đeo Chéo',
        description:
          'Túi đeo chéo nhỏ gọn, tiện lợi cho các hoạt động hàng ngày. Thiết kế trẻ trung, năng động với nhiều ngăn chứa phù hợp để mang theo điện thoại, ví, chìa khóa và các vật dụng cá nhân khác.',
        is_active: true,
      },
      {
        name: 'Vali Du Lịch',
        description:
          'Vali chất lượng cao cho các chuyến du lịch dài ngày. Với chất liệu bền bỉ, bánh xe xoay 360 độ mượt mà và tay kéo chắc chắn, vali của chúng tôi sẽ đồng hành cùng bạn trong mọi hành trình.',
        is_active: true,
      },
      {
        name: 'Túi Tote',
        description:
          'Túi tote rộng rãi, phù hợp để mang theo nhiều vật dụng. Với thiết kế đơn giản nhưng tinh tế, túi tote là lựa chọn hoàn hảo cho việc đi chợ, đi làm hoặc đi chơi cuối tuần.',
        is_active: true,
      },
      {
        name: 'Phụ Kiện',
        description:
          'Những phụ kiện thời trang cao cấp để bổ sung cho phong cách của bạn. Từ khăn lụa mềm mại đến móc khóa độc đáo, mỗi phụ kiện đều được thiết kế tỉ mỉ để tôn vinh vẻ đẹp của bạn.',
        is_active: true,
      },
      {
        name: 'Túi Đựng Laptop',
        description:
          'Túi đựng laptop chuyên dụng với ngăn đệm bảo vệ thiết bị công nghệ. Thiết kế hiện đại với nhiều ngăn phụ để tổ chức các phụ kiện như sạc, chuột, tài liệu một cách gọn gàng.',
        is_active: true,
      },
      {
        name: 'Túi Du Lịch',
        description:
          'Túi du lịch đa năng với nhiều kích thước phù hợp cho các chuyến đi ngắn hoặc dài ngày. Chất liệu chống thấm nước, khóa kéo bền bỉ và nhiều ngăn chứa giúp bạn sắp xếp hành lý một cách hiệu quả.',
        is_active: true,
      },
    ],
    skipDuplicates: true,
  ...
  const productsData = [
    ...
    },
    {
      ...
      description:
        'Túi xách da lộn với thiết kế trẻ trung, phù hợp cho các bạn trẻ năng động. Nhiều ngăn chứa tiện lợi và khóa kéo chắc chắn. Thiết kế hiện đại với các đường chỉ may tỉ mỉ, khóa kéo chống gỉ sét và quai đeo có thể tháo rời. Bên trong có ngăn laptop 13 inch, ngăn điện thoại và nhiều ngăn nhỏ để thẻ.',
      price: 129.99,
    ...
    },
    {
      ...
      description:
        'Ba lô nhỏ gọn lý tưởng cho các chuyến đi ngắn ngày. Thiết kế gọn nhẹ với nhiều ngăn chứa tiện lợi. Chất liệu vải oxford bền bỉ với khả năng chống thấm nước tốt. Có ngăn chính rộng rãi, ngăn laptop 15 inch, ngăn phụ và ngăn phía trước. Dây đeo có đệm êm ái và tay cầm chắc chắn giúp mang vác thoải mái.',
      price: 89.99,
      category_id: categoryList[2].id,
    ...
    // Ví
    {
      ...
      description:
        'Chiếc ví gấp đôi cổ điển với nhiều ngăn thẻ và ngăn tiền. Được làm từ da bò thật mềm mại, bền đẹp theo thời gian. Thiết kế với 6 ngăn thẻ trong suốt, 2 ngăn tiền giấy rộng rãi và ngăn xu riêng biệt. Đường chỉ may tỉ mỉ, khóa kéo mượt mà và logo in chìm sang trọng. Kích thước vừa vặn cho nam và nữ.',
      price: 59.99,
    ...
    },
    {
      ...
      description:
        'Túi đeo chéo phong cách unisex phù hợp cho cả nam và nữ. Thiết kế đơn giản nhưng tinh tế. Chất liệu vải kaki bền bỉ với khả năng chống thấm nước nhẹ. Thiết kế với ngăn chính rộng rãi, ngăn điện thoại riêng biệt và ngăn phía trước. Dây đeo có đệm êm ái và khóa cài chắc chắn giúp mang vác thoải mái.',
      price: 49.99,
      category_id: categoryList[4].id,
      brand: 'Hapas Active',
    ...
    },
    {
      ...
      description:
        'Túi tote sang trọng làm từ da lộn cao cấp. Thiết kế tối giản nhưng vẫn giữ được sự thời trang. Chất liệu da lộn cao cấp với khả năng chống thấm nước tốt. Thiết kế với quai đeo da thật mềm mại, ngăn chính rộng rãi và đáy túi có chân đệm chắc chắn. Có thể sử dụng như túi xách tay hoặc túi đeo vai.',
      price: 89.99,
      category_id: categoryList[6].id,
      brand: 'Hapas Luxe',
      material: 'Da Lộn Cao Cấp',
    ...
    },
    {
      ...
      description:
        'Bộ móc khóa thời trang với nhiều thiết kế độc đáo. Chất liệu hợp kim bền đẹp, chống gỉ sét. Chất liệu hợp kim cao cấp với khả năng chống gỉ sét và phai màu. Thiết kế với nhiều hình dạng độc đáo như trái tim, ngôi sao, hình học... Có thể sử dụng như móc khóa túi xách, móc khóa balo hoặc trang sức thời trang.',
      price: 15.99,
      category_id: categoryList[7].id,
      brand: 'Hapas Charm',
